...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1383798167;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BigInt> crateUtilsAvailableValue({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BigInt> crateUtilsAvailableValue({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateUtilsAvailableValueConstMeta,
        argValues: [inputs, targetFeerate],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateUtilsAvailableValueConstMeta => const TaskConstMeta(
    debugName: "available_value",
    argNames: ["inputs", "targetFeerate"],
  );
  ...
  CoinSelectionOpt dco_decode_coin_selection_opt(dynamic raw) {
    ...
    return CoinSelectionOpt(
      ...
      maxValue: dco_decode_u_64(arr[11]),
      maxSelectionWeight: dco_decode_u_64(arr[12]),
    );
  }
  ...
  CoinSelectionOpt sse_decode_coin_selection_opt(SseDeserializer deserializer) {
    ...
    var var_maxValue = sse_decode_u_64(deserializer);
  ...
  void sse_encode_coin_selection_opt(
    ...
    sse_encode_u_64(self.maxValue, serializer);
